...
const en: Translation = {
  ...
  activity: {
    ...
    subtitle: "Public TicketBought events verified directly on Polygon. Updates automatically.",
  ...
  winners: {
    title: "Past winners",
    subtitle: "Public WinnerPicked events verified directly on Polygon. Updates automatically.",
...
const dictionaries: Record<Exclude<Language, "en">, Partial<Translation>> = {
  ru: {
    ...
    activity: { title: "Недавние покупки", subtitle: "Публичные события TicketBought проверяются напрямую в Polygon и обновляются автоматически.", locked: "Загружаем публичную активность контракта.", unavailable: "История Polygon временно недоступна. Последняя подтверждённая активность будет сохранена.", empty: "Записанных покупок билетов не найдено.", buyer: "Покупатель", round: "Раунд", price: "Цена", winner: "Победитель", prize: "Приз", tx: "Транзакция", time: "Время" },
    winners: { title: "Прошлые победители", subtitle: "Публичные события WinnerPicked проверяются напрямую в Polygon и обновляются автоматически.", locked: "Загружаем завершённые розыгрыши.", unavailable: "История Polygon временно недоступна. Последние подтверждённые результаты будут сохранены.", empty: "Завершенных розыгрышей пока нет.", buyer: "Покупатель", round: "Раунд", price: "Цена", winner: "Победитель", prize: "Приз", tx: "Транзакция", time: "Время" },
